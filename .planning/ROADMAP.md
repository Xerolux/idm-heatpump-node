...
- [ ] 01-01-PLAN.md — Establish the strict exact-baseline trust boundary before upstream execution.
- [ ] 01-02-PLAN.md — Generate deterministic public API, codec, register, and scenario golden contracts.
...
| ------------------------------------------ | -------------- | ----------- | --------- |
| 1. Reproducible Semantic Contract          | 0/10           | Planned     | -         |
