  ...
  it("generates complete fixtures with exact API, class, codec, schema, read, and write facts", () => {
    ...
    expect(writeNames).toEqual(
      expect.arrayContaining([
        ...
        "write_validation_not_numeric",
        "write_numeric_string_empty_rejected",
        "write_numeric_string_integer_simulate",
        "write_numeric_string_float_simulate",
        "write_numeric_string_exponent_simulate",
        "write_numeric_string_whitespace_set_value_dry_run",
        "write_numeric_string_underscore_real_fc16",
        "write_numeric_string_nonfinite_nan",
        "write_numeric_string_nonfinite_positive_infinity",
        "write_numeric_string_nonfinite_negative_infinity",
