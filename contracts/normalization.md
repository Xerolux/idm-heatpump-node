...
| write safety      | `write_unknown_register`, `write_read_only`, `write_model_unavailable`, `write_boolean_required`, `write_boolean_for_numeric`, `write_not_numeric`, `write_nonfinite`, `write_integer_required`, `write_excluded`, `write_below_minimum`, `write_above_maximum`, `write_enum_unsupported`, `write_eeprom_throttled`                                          |
